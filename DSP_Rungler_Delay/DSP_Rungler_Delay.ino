// VS1053b DSP code hack - Rungler with delay //
...
void setup() {
  ...
  WriteRegister(SCI_AUDATA, 8000);      // set sample rate 8000 Hz

}

void loop() {

  uint8_t tune = random(1, 15);

  WriteRegister(SCI_AICTRL0, data);
  WriteRegister(SCI_AICTRL1, tune);
...
const static word plugin[PLUGIN_SIZE] PROGMEM = {
  ...
  0x0007,0x0001, /*copy 1*/
	...
	0x0002,0x0090,0x2912,0x0ec0,0x3800,0x0024,0xf400,0x4001,
	0x0000,0x1000,0x6100,0x0024,0x0000,0x1000,0x2800,0x4889,
	0x0000,0x0024,0x3413,0x184c,0xf400,0x4512,0xf400,0x4510,
	0x2912,0x1f80,0x34f3,0x0024,0x0000,0x0003,0x0000,0x0800,
	0x6302,0x104c,0x0000,0x0024,0x2800,0x57c1,0x3009,0x184c,
	0x0002,0x0090,0x3000,0x13cc,0x0002,0x0110,0xb58a,0x0004,
	0x0002,0x00d0,0x6800,0x9bcc,0xae02,0x0024,0x0007,0xd001,
	0xb880,0x2000,0x0002,0x0050,0x3000,0x8024,0x6122,0x0024,
	0x0002,0x00d0,0x2800,0x5301,0x0000,0x0024,0x6890,0x0024,
	0x6894,0x0001,0xd102,0x984c,0xb122,0x2001,0x0002,0x0110,
	0x3000,0x0024,0x4000,0x0024,0xc018,0x2000,0x0010,0x0001,
	0xb880,0x2004,0xb884,0x3840,0x3e10,0x4024,0x3e10,0x8024,
	0x2900,0x15c0,0x3e01,0x0024,0x6396,0x9b0c,0x6802,0x4490,
	0x3a20,0x004c,0x2800,0x4dc0,0x3800,0x4024,0x3e10,0x0024,
	0x290c,0x7300,0x3e15,0x13cc,0x2800,0x4880,0x36e3,0x0024,
	...
	0x0030,0x10d1,0x2800,0x6405,0x0001,0x800a,0x0006,0x6514,
	...
	0x48b2,0x0024,0xac22,0x0024,0x2800,0x6780,0xf7cc,0x1002,
	...
	0x2800,0x6b95,0x0000,0x0024,0x2800,0x6c81,0x0006,0x6410,
	0x3050,0x0024,0x3000,0x4024,0x6014,0x0024,0x0000,0x0024,
	0x2800,0x6ad9,0x0000,0x0024,0xf400,0x4040,0x38b0,0x0024,
	0x2800,0x6c80,0x3800,0x0024,0x2800,0x6c41,0x0000,0x0024,
