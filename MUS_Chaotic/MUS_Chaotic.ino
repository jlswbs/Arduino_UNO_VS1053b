// VS1053b MIDI - Chaotic random model music //
...
void loop() {
  ...
  srand((int)chaos_rand(65536));

  uint8_t drums = chaos_rand(256);
  uint8_t note0 = 24 + chaos_rand(65);
  uint8_t note1 = 48 + chaos_rand(25);
  uint8_t note2 = 48 + chaos_rand(13);
  uint8_t note3 = 36 + chaos_rand(37);
  uint8_t note4 = 24 + chaos_rand(49);
  uint8_t prog = 96 + chaos_rand(14);

  note_on(0, 0, note0, 36 + rand()%64);
  note_on(1, 10, note1, 36 + rand()%56);
  note_on(2, 79, note2, 36 + rand()%56);
  note_on(3, prog, note3, 24 + rand()%48);
  note_on(4, 42, note4, 24 + rand()%48);

  if (bitRead(drums, 0)) note_on(9, 0, 35, 96);
  if (bitRead(drums, 1)) note_on(9, 0, 37, 64);
  if (bitRead(drums, 2)) note_on(9, 0, 38, 64);
  if (bitRead(drums, 3)) note_on(9, 0, 39, 64);
  if (bitRead(drums, 4)) note_on(9, 0, 40, 64);
  if (bitRead(drums, 5)) note_on(9, 0, 41, 64);
  if (bitRead(drums, 6)) note_on(9, 0, 42, 64);
  if (bitRead(drums, 7)) note_on(9, 0, 43, 64);
